...
export default {
  ...
  methods: {
    async getCraftTypeData() {
      ...
      const res = await reqCountDeviceMain(this.companyCode,'','04', this.date, this.dayType)
    ...
    handleClick(item) {
      ...
      // 后台数据没有code值，所以用workCenterName
      const deviceHomeObj = {type: '02',typeCode: item.workCenterName} // 类型 01 工艺，02 加工中心，03 设备类型 
