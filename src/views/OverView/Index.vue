        ...
        .statusList{
          ...
          .statusListBottom{
            ...
            li{
              ...
              .open{
                background: url("../../assets/images/blueC.png") no-repeat center;
                background-size: 65% 100%;
              }
              .runHourNum{
                background: url("../../assets/images/greenC.png") no-repeat center;
                background-size: 65% 100%;
              }
              .start{
                background: url("../../assets/images/yellowPie.png") no-repeat center;
                background-size: 65% 100%;
              }
              .runLV{
                background: url("../../assets/images/blueEcharts.png") no-repeat center;
                background-size: 65% 100%;
              }
              .problem{
                background: url("../../assets/images/peoblemLv.png") no-repeat center;
                background-size: 65% 100%;
              }
              .totalE{
                background: url("../../assets/images/blueC.png") no-repeat center;
