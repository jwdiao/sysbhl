      ...
      <div class="sbhl_left">
        <div class="sbhl_left_top">
          <div class="sbhltitle clear">
            ...
            <div class="right">
            <div class="inlineBlock marginRight30 paddingTop10">
              计划工件数 :
              <span>{{deviceData.planProcedureNum}}</span>
            </div>
            </div>
          </div>
        ...
        switch (requestType){
          ...
          case '10' : //右侧本日
            ...
            if(res10&&res10.code===200){
              ...
              this.chartsCData.startUpRateArr = res10.data.startUpRateArr.map(item => (item>100)?100:item)
              // this.chartsCData.runRateArr = res10.data.runRateArr; // 作业率
              this.chartsCData.runRateArr = res10.data.runRateArr.map(item => (item>100)?100:item); // 作业率
              var newArr10 = []
          ...
          case '11' : //右侧本月
            ...
            if(res11&&res11.code===200){
              ...
              this.chartsBData.startUpRateArr = res11.data.startUpRateArr.map(item => (item>100)?100:item); // 开机率
              // this.chartsBData.runRateArr = res11.data.runRateArr; // 作业率
              this.chartsBData.runRateArr = res11.data.runRateArr.map(item => (item>100)?100:item); // 作业率
              var newArr11 = []
          ...
          case '12' : //右侧本年
            ...
            if(res12&&res12.code===200){
              ...
              this.chartsAData.startUpRateArr = res12.data.startUpRateArr.map(item => (item>100)?100:item); // 开机率
              // this.chartsAData.runRateArr = res12.data.runRateArr; // 作业率
              this.chartsAData.runRateArr = res12.data.runRateArr.map(item => (item>100)?100:item); // 作业率
              var newArr12 = []
