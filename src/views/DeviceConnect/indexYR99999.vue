<template>
  <div class="device">
    <div class="device_head">
      <div class="leftInfo" @click="$router.push('/DeviceHome')"><img src="../../assets/images/index_back.png"></div>
      ...
      <div class="device_main">
        <div class="device_mainLeft">
          <div class="device_leftTop">
              ...
              <div class="timeBox">
                <span class="text" v-if="deviceDataObj.machineStatus==1">运行</span>
                <span class="text" v-if="deviceDataObj.machineStatus==2">待机</span>
                <span class="text" v-if="deviceDataObj.machineStatus==3">关机</span>
                <span class="text" v-if="deviceDataObj.machineStatus==4">故障</span>
          ...
          <div class="device_leftBottom" >
            <el-scrollbar style="height:100%;" >
              <ul>
                <li v-for="(item,index) in deviceData.curNcBlk" :key="item" :class='"curNcBlk"+index'>{{item}}</li>
              </ul>
            </el-scrollbar>
          </div>
        </div>
                ...
                <ul class="centerConent dljitem">
                  <li class="centerContentLi">
                    <ul class="centerContentDiv" style="margin-bottom: -0.3rem;">
                      <li class="centerContentDivSpanZhuZhou"><em>命令主轴转速</em> </li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.scode)||0}}&nbsp;(RPM)</em></li>
                    </ul>
                    <ul class="centerContentDiv">
                      <li class="centerContentDivSpanZhuZhou"><em>实际主轴转速 </em></li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.actSpin)||0}}&nbsp;(RPM)</em></li>
                    </ul>
                  </li>
                  <li class="centerContentLi">
                    <ul class="centerContentDiv" style="margin-bottom: -0.3rem;">
                      <li class="centerContentDivSpanZhuZhou"><em>主轴负载</em> </li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.spinLoad)||0}}&nbsp;%</em></li>
                    </ul>
                    <ul class="centerContentDiv">
                      <li class="centerContentDivSpanZhuZhou"><em>主轴最大负载 </em></li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.maxSpinLoad)||0}}&nbsp;%</em></li>
                    </ul>
                  </li>
                  <li class="centerContentLi">
                    <ul class="centerContentDiv" style="margin-bottom: -0.3rem;">
                      <li class="centerContentDivSpanZhuZhou"><em>命令进给率</em> </li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.fCode)||0}}</em></li>
                    </ul>
                    <ul class="centerContentDiv">
                      <li class="centerContentDivSpanZhuZhou"><em>实际进给率 </em></li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.actFeed)||0}}</em></li>
                    </ul>
                  ...
                  <li class="centerContentLi">
                    <ul class="centerContentDiv" style="margin-bottom: -0.3rem;">
                      ...
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.spinTmp1)||0}}</em></li>
                    </ul>
                    <ul class="centerContentDiv">
                      <li class="centerContentDivSpanZhuZhou"><em>主轴二温度 </em></li>
                      <li class="centerContentDivSpanZhuZhouNumber"><em>&nbsp;&nbsp;&nbsp;{{Math.floor(deviceData.spinTmp2)||0}}</em></li>
                    </ul>
                   <!-- <div class="centerContentDiv">
                      ...
                      <ul class="bottomConentLiRightUl">
                        <li>
                          ...
                          <ul class="bottomConentLiRightUlFS FSnumber">
                            <li>{{deviceData.fV||0}}</li>
                            <li>1{{deviceData.ovFeed||0}}</li>
                            <li>{{deviceData.actFeed||0}}</li>
                          </ul>
                        </li>
                        <li>
                          ...
                          <ul class="bottomConentLiRightUlFS FSnumber">
                            <li>{{deviceData.rV||0}}</li>
                            <li>{{deviceData.ovSpin||0}}</li>
                            <li>{{deviceData.spinLoad||0}}</li>
                          </ul>
                        </li>
                      </ul>
                    </li>
...
import {reqDeviceRightList} from '../../api'
...
.selectCompany_con{
  position: fixed;right:20px;top:60px;z-index:22;
  width: 300px;
...
.device_titleBox{
  ...
  .device_circle{
    margin-left: 5px; font-size: 32px; color: rgb(2, 201, 252);
    display: inline-block;vertical-align: middle;
  }
  .device_title{
    display: inline-block;vertical-align: middle;
    font-size: 28px;color:#fff;margin-left:10px;
    font-weight: bold;
  }
  .device_img{
...
.device_head{
  ...
  .title{
    flex: 2;
    font-size:0.42rem;color:#fff;text-align: center;line-height: 1.3rem;font-weight:bold;
  }
  .rightInfo{
    flex: 1;
...
.device_leftTop{
  ...
  .name{ font-size: 30px;color:#fff; text-align: center;height:40px;}
  .img{width: 100%;margin:10px auto 0;text-align: center;flex:1;display: flex;
      justify-content: center;
      align-items: center;
	}
  .timeBox{
    width: 266px;height:90px;position: relative;margin:10px auto 0;
    // border:1px solid red;
    background-image: url(../../assets/images/DeviceConnect_time.png);
    background-size: 100% 100%;
  }
  .text{font-size:36px;color:#01ff8a;position:absolute;top:20px;left:20px;}
  .time{font-size:22px;color:#00fcf9;position:absolute;bottom:5px;right:20px;}
}
.device_leftBottom{
  background: rgba(0, 186, 255, 0.1);
  margin-top:15px;font-size:18px;color:#aec9ff;
  padding:15px;
  flex:1;
	//height:276px;
  overflow: hidden;
...
.device_mainRight{
  height:100%;width: calc(100% - 410px - 15px);
  flex:1;
...
.device_rightTop{
  background: rgba(39, 69, 111, 0.3);padding: 15px;flex:1.47;
}
.device_rightBottom{
// margin:15px;
  margin-top:15px;
    ...
    .centerContentLi{
      ...
      .centerContentDiv{
        ...
        .centerContentDivSpan{
          ...
          color: #ffffff;
          em{
            font-size: 0.24rem; color: #00c7fa;
          }
        }
