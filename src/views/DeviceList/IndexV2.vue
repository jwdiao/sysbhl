...
<style lang="scss" scoped>
	.bottom_message {
		...
		.statusBar_box{
			...
			z-index: 2;
			.statusBar{
				width: 21px;height: 49px;border-radius: 4px;
			}
			.statusBar_line{
				width: 2px;height: 22px;
			}
			img{
				position: absolute;top:-50px;left:-79px;z-index: 2;
			}
			.greenBg{ background-color:#1cf33c; }
			.orangeBg{ background-color:#ffc31f; }
			.redBg{ background-color:#531a34; }
			.grayBg{ background-color:#838990; }
		}
