							...
							>
								<div class="lookBox_bottom">
									<div class="deviceList_ImgAndStatus">
										...
										<div class="deviceList_statusImg" v-if="item.machineStatus == 1"><img src="../../assets/images/deviceList_lamp_green2.png" /></div>
										<div class="deviceList_statusImg" v-if="item.machineStatus == 2"><img src="../../assets/images/deviceList_lamp_orange2.png" /></div>
										<div class="deviceList_statusImg" v-if="item.machineStatus == 4"><img src="../../assets/images/deviceList_lamp_red2.png" /></div>
										<div class="deviceList_statusImg" v-if="item.machineStatus == 3"><img src="../../assets/images/deviceList_lamp_gray2.png" /></div>
										<div :class="{
...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.type = JSON.parse(craftOrCenter).type; // 工艺和加工中心区分类型：01工艺，02加工中心 03 设备类型
        ...
        // this.deviceInfoArrData = this.$route.params.deviceInfoArr
			...
			async getOnlineboard() {
				...
				const currentDate = this.getDayStrFun();
